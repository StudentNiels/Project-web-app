            ...
            <div class="col-md-2 col-sm-2 col-xs-1 col-lg-2 float-left col-2 pl-0 pr-0 collapse width show logobg" id="sidebar">
                ...
                <div class="list-group border-0 card text-center text-md-left">
                    ...
                    <form class="form-inline list-group-item d-inline-block collapsed">
                        ...
                        <input class="form-control- form-control-sm ml-3 w-50 d-sm-none d-md-inline"  type="text" aria-label="Search">
                    </form>
                    ...
                    <a href="index_EN.php" class="list-group-item d-inline-block collapsed uwu"data-parent="#sidebar"><i class="fas fa-flag"></i> <span class="d-none d-md-inline">English</span></a>
