    ...
    <body class="bcolor">
        ...
        <div class="container-fluid">
            <div class="row d-flex d-md-block flex-nowrap wrapper">
                <div class="col-md-10 col-sm-10 col-xs-11 float-left pl-0 pr-0">
                    <div class="videos">
                        <div class="vak">
                            <?php
                            ...
                            if ($statement = mysqli_prepare($conn, $SQLstring)) {
                                if (mysqli_stmt_execute($statement) === TRUE) {
                                    ...
                                    if (mysqli_stmt_num_rows($statement) == 0) {
                                        echo "<h1>No video's have been uploaded yet!</h1>";
                                    } else {
                                        while (mysqli_stmt_fetch($statement)) {
                                            echo "<div class='vakHeader'>
                                                    <a href='videolijst.php?vak=" . $vak . "'><h2 class='vakTitel'>" . $vak . "</h2></a>
                                                    <a class='vakTitel' href='addfav_EN.php?vak=" . $vak . "&cat=add'><h7>Add Favorites</h7></a>
                                                </div>";
                                            echo $vaktitel;
